...
public class Profesor {
    ...
    /**
     * Identificador único del profesor el cual esta compuesto por 4 digitos(clave
     * primaria).
     */
    @Id
    ...
    /*
     * Apellido materno del profesor, este puede ser nulo ya que hay personas que
     * puede que no tengan los 2 apellidos.
     */
