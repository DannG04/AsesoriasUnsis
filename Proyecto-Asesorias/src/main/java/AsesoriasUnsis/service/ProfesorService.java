...
public class ProfesorService {
    ...
    @Autowired
    private ProfesorRepository profesorRepository;    public Profesor obtenerProfesor() {
     ...
     */    /**
     * Obtiene los datos del perfil del profesor de diferentes entidades usando la función de BD.
     * 
